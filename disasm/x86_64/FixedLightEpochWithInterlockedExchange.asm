; Assembly listing for method Tsavorite.core.FixedLightEpochWithInterlockedExchange:ProtectAndDrain():this (FullOpts)
...
G_M000_IG04:
       ...
       mov      rdi, rbx
       call     [Tsavorite.core.FixedLightEpochWithInterlockedExchange:Drain(long):this]
...
G_M000_IG07:
       ...
       pop      rbx
       pop      rbp
       tail.jmp [Tsavorite.core.FixedLightEpochWithInterlockedExchange:SuspendResume():this]
...
; Assembly listing for method Tsavorite.core.FixedLightEpochWithInterlockedExchange:ComputeNewSafeToReclaimEpoch(long):long:this (FullOpts)
; Emitting BLENDED_CODE for X64 with AVX - Unix
; FullOpts code
; optimized code
; rbp based frame
