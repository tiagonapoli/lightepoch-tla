...
namespace Tsavorite.core
{
    ...
    /// Epoch protection
    /// </summary>
    public sealed unsafe class FixedLightEpoch : IEpochAccessor
    {
        /// <summary>
        ...
        public void ProtectAndDrain()
        {
            ...
            System.Threading.Interlocked.MemoryBarrier(); // FIX: StoreLoad fence closes the announce->load window
        ...
        /// and re-fencing here is redundant. Verified safe by tla/FixedLightEpochTsavoriteNoAnnounce.tla.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
