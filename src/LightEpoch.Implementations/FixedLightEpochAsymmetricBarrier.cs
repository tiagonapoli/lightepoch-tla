...
namespace Tsavorite.core
{
    ...
    /// Epoch protection
    /// </summary>
    public sealed unsafe class FixedLightEpochAsymmetricBarrier : IEpochAccessor
    {
        /// <summary>
        ...
        /// </summary>
        public FixedLightEpochAsymmetricBarrier()
        {
        ...
        {
            // FIX (asymmetric): flush every core's store buffer so this scan observes
            // all readers' announce stores. Reader hot path pays nothing.
            AsymmetricBarrier.FullBarrierAllCores();
        ...
        void ReserveEntryWait(ref int entry)
        {
            ...
            try
            {
                ...
                if ((newCount & kDisposedFlag) != 0)
                    throw new ObjectDisposedException(nameof(FixedLightEpochAsymmetricBarrier));
