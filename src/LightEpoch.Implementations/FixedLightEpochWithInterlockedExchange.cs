...
namespace LightEpoch.Core
{
    ...
    public sealed unsafe class FixedLightEpochWithInterlockedExchange
    {
        ...
        /// </summary>
        public FixedLightEpochWithInterlockedExchange()
        {
        ...
        public void ProtectAndDrain()
        {
            ...
            System.Threading.Interlocked.Exchange(ref (*(tableAligned + entry)).localCurrentEpoch, CurrentEpoch); // FIX: seq-cst RMW announce (implicit StoreLoad fence)
        ...
        void ReserveEntryWait(ref int entry)
        {
            ...
            try
            {
                ...
                if ((newCount & kDisposedFlag) != 0)
                    throw new ObjectDisposedException(nameof(FixedLightEpochWithInterlockedExchange));
